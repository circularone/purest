...
/**
 * Class EntityListDenormalizerForm.
 */
class EntityListDenormalizerForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['description'] = [
      '#type' => 'html_tag',
      '#tag' => 'p',
      '#value' => $this->t('Select entity type bundle to edit the denormalizer settings for that bundle.'),
    ];
        ...
        $form['entity_list'][$bundle_id]['actions'] = [
          ...
          '#links' => [
            'edit' => [
              'title' => $this
                ->t('Edit'),
              'url' => Url::fromRoute('purest.denormalizer.entity', [
                'type' => $entity_type_id,
                'bundle' => $bundle_id,
              ]),
            ],
